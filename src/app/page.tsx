...
const GALLERY_IMAGES = [
  { src: "/images/gambas-ajillo.webp", alt: "Gambas al Ajillo", w: 600, h: 800 },
  { src: "/images/arroz-banda.webp", alt: "Arroz a Banda", w: 600, h: 450 },
  { src: "/images/pulpo-gallega.jpg", alt: "Pulpo a la Gallega", w: 600, h: 800 },
  { src: "/images/dining-room.jpg", alt: "Salón del restaurante", w: 600, h: 350 },
  { src: "/images/zamburinas.webp", alt: "Zamburiñas a la plancha", w: 600, h: 800 },
  { src: "/images/grilled-meat.jpg", alt: "Solomillo a la plancha", w: 600, h: 350 },
  { src: "/images/sepionet.webp", alt: "Sepionet plancha", w: 600, h: 450 },
  { src: "/images/torrijas-dessert.jpg", alt: "Torrijas del Chef", w: 600, h: 350 },
  { src: "/images/gambas-plancha.webp", alt: "Gambas a la plancha", w: 600, h: 800 },
  { src: "/images/arroz-bacalao.webp", alt: "Arroz de bacalao", w: 600, h: 600 },
  { src: "/images/exterior.webp", alt: "Fachada del restaurante", w: 600, h: 450 },
  { src: "/images/bar-interior.webp", alt: "Barra del restaurante", w: 600, h: 450 },
];
...
function ReviewCard({ review }: { review: typeof REVIEWS_ROW1[0] }) {
  return (
    <div className="review-card rounded-2xl px-6 py-5 min-w-[340px] max-w-[380px] flex-shrink-0 mx-3">
      <div className="flex items-center justify-between mb-3">
        <Stars count={review.rating} />
        <span className="text-white/40 text-xs font-[family-name:var(--font-inter)]">{review.date}</span>
      </div>
      <p className="text-white/80 text-sm leading-relaxed font-[family-name:var(--font-inter)] mb-3">
        &ldquo;{review.text}&rdquo;
      </p>
      <p className="text-gold text-sm font-semibold font-[family-name:var(--font-playfair)]">
        {review.name}
      </p>
    </div>
  );
    ...
    <>
      ...
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
          scrolled
            ? "bg-dark/90 nav-blur border-b border-gold/10 py-3"
            : "bg-transparent py-5"
        }`}
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <a href="#hero" className="flex items-center gap-2">
            <span className="text-2xl font-bold font-[family-name:var(--font-playfair)] text-gradient-gold tracking-wide">
              El Cortijillo
            </span>
          </a>
          <div className="hidden lg:flex items-center gap-8">
            {NAV_LINKS.map((l) => (
              <a
                key={l.href}
                href={l.href}
                className="text-sm text-white/70 hover:text-gold transition-colors font-[family-name:var(--font-inter)] tracking-wide uppercase"
              >
                {l.label}
              </a>
            ))}
            <a
              href="tel:+34965682817"
              className="ml-2 px-5 py-2 border border-gold/50 text-gold text-sm rounded-full hover:bg-gold hover:text-dark transition-all font-[family-name:var(--font-inter)] tracking-wide"
            >
              Reservar
            </a>
          </div>
        ...
        {navOpen && (
          <div className="lg:hidden bg-dark/95 nav-blur border-t border-gold/10 mt-2">
            <div className="flex flex-col items-center py-6 gap-5">
              {NAV_LINKS.map((l) => (
                <a
                  ...
                  className="text-white/70 hover:text-gold transition-colors font-[family-name:var(--font-inter)] tracking-wide uppercase text-sm"
                >
                  {l.label}
                </a>
              ))}
              <a
                href="tel:+34965682817"
                className="px-6 py-2 border border-gold/50 text-gold text-sm rounded-full hover:bg-gold hover:text-dark transition-all"
              >
                Reservar
              </a>
            </div>
      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl">
          <p className="reveal text-gold tracking-[0.35em] uppercase text-sm font-[family-name:var(--font-inter)] mb-6">
            Tapería &middot; Arrocería &middot; Restaurante
          </p>
          <h1 className="reveal font-[family-name:var(--font-playfair)] text-5xl sm:text-7xl md:text-8xl font-bold text-white leading-[1.05] mb-6">
            El{" "}
            <span className="text-gradient-gold italic font-[family-name:var(--font-lora)]">
              Cortijillo
            </span>
          </h1>
          <p className="reveal text-white/60 font-[family-name:var(--font-lora)] italic text-lg sm:text-xl mb-4">
            de Juan Diego
          </p>
          <div className="reveal gold-line mx-auto my-8" />
          <p className="reveal text-white/70 font-[family-name:var(--font-inter)] text-base sm:text-lg max-w-2xl mx-auto leading-relaxed mb-10">
          ...
          <div className="reveal flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="#menu"
              className="px-8 py-3.5 bg-gold text-dark font-semibold rounded-full hover:bg-gold-light transition-all text-sm tracking-wide font-[family-name:var(--font-inter)] uppercase"
            >
              Ver Carta
            </a>
            <a
              href="tel:+34965682817"
              className="px-8 py-3.5 border border-white/30 text-white rounded-full hover:border-gold hover:text-gold transition-all text-sm tracking-wide font-[family-name:var(--font-inter)] uppercase"
            >
              Reservar Mesa
            </a>
          </div>
      ...
      {/* ─── STATS BAR ─── */}
      <section className="bg-charcoal border-y border-gold/10">
        <div className="max-w-6xl mx-auto px-6 py-8 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            ...
            <div key={s.label} className="reveal">
              <p className="text-3xl md:text-4xl font-bold font-[family-name:var(--font-playfair)] text-gradient-gold">
                {s.value}
              </p>
              <p className="text-white/50 text-sm mt-1 font-[family-name:var(--font-inter)]">{s.label}</p>
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="reveal-left">
              <p className="text-gold tracking-[0.3em] uppercase text-xs font-[family-name:var(--font-inter)] mb-4">
                Nuestra Historia
              </p>
              <h2 className="font-[family-name:var(--font-playfair)] text-4xl md:text-5xl font-bold text-white leading-tight mb-6">
                Donde la{" "}
                <span className="italic font-[family-name:var(--font-lora)] text-gradient-gold">
                  tradición
                </span>{" "}
                se encuentra con la pasión
              </h2>
              <div className="gold-line mb-8" />
              <p className="text-white/70 font-[family-name:var(--font-inter)] leading-relaxed mb-6">
              ...
              <p className="text-white/70 font-[family-name:var(--font-inter)] leading-relaxed mb-8">
              ...
              <div className="flex flex-wrap gap-6">
                {["Mediterránea", "Española", "Europea"].map((c) => (
                  <span
                    key={c}
                    className="text-sm text-gold/80 border border-gold/20 px-4 py-1.5 rounded-full font-[family-name:var(--font-inter)]"
                  >
                    {c}
                  </span>
                ))}
      ...
      {/* ─── MENU ─── */}
      <section id="menu" className="py-24 md:py-32" ref={menuRef}>
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16 reveal">
            ...
            <p className="text-white/60 font-[family-name:var(--font-inter)] max-w-xl mx-auto">
          ...
          <div className="reveal flex flex-wrap justify-center gap-2 mb-12">
            {MENU_CATEGORIES.map((cat) => (
              <button
                ...
                className={`px-5 py-2 text-sm rounded-full transition-all font-[family-name:var(--font-inter)] tracking-wide ${
                  menuCat === cat.key
                    ? "bg-gold text-dark font-semibold"
                    : "text-white/60 border border-white/10 hover:border-gold/40 hover:text-gold"
                }`}
              >
                {cat.label}
              </button>
          ...
          <div className="grid md:grid-cols-2 gap-x-12 gap-y-6">
            {MENU[menuCat].map((item, i) => (
              <div
                key={item.name}
                className="flex justify-between items-start py-4 border-b border-white/5 group"
                style={{ animationDelay: `${i * 50}ms` }}
              >
                <div className="flex-1">
                  <h3 className="font-[family-name:var(--font-playfair)] text-lg font-semibold text-white group-hover:text-gold transition-colors">
                    {item.name}
                  </h3>
                ...
                <span className="text-gold font-bold font-[family-name:var(--font-playfair)] text-lg ml-4 whitespace-nowrap">
                  {item.price}
                </span>
              </div>
            ))}
          ...
          <div className="text-center mt-12 reveal">
            <p className="text-white/30 text-xs font-[family-name:var(--font-inter)] italic">
      ...
      <section className="py-24 md:py-32 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-wine-dark/30 to-transparent" />
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="reveal-left">
              ...
              <h2 className="font-[family-name:var(--font-playfair)] text-4xl md:text-5xl font-bold text-white leading-tight mb-6">
                Carta de{" "}
                <span className="italic font-[family-name:var(--font-lora)] text-gradient-gold">Vinos</span>
              </h2>
              <div className="gold-line mb-8" />
              <p className="text-white/70 font-[family-name:var(--font-inter)] leading-relaxed mb-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={w.region} className="border border-gold/15 rounded-xl p-4">
                    <p className="font-[family-name:var(--font-playfair)] font-semibold text-white text-sm">
                      {w.region}
                    </p>
                    <p className="text-gold/60 text-xs font-[family-name:var(--font-inter)] mt-1">
                      {w.count}
                    </p>
                  </div>
                ))}
            ...
            <div className="reveal-right flex justify-center">
              <div className="relative">
                <div className="absolute -inset-8 bg-gradient-to-br from-gold/5 to-transparent rounded-3xl" />
                <div className="relative grid grid-cols-2 gap-3">
                  {[
                    ...
                    <div
                      key={w.name}
                      className="bg-white/[0.03] border border-gold/10 rounded-xl p-4 hover:border-gold/30 transition-all"
                    >
                      <p className="font-[family-name:var(--font-playfair)] font-bold text-white text-sm">
                        {w.name}
                      </p>
                      <p className="text-gold/50 text-xs font-[family-name:var(--font-inter)] italic">
                        {w.type}
                      </p>
                      <p className="text-gold font-bold font-[family-name:var(--font-playfair)] mt-2">
                        {w.price}
                      </p>
                    </div>
                  ))}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="columns-2 md:columns-3 gap-4 space-y-4">
            {GALLERY_IMAGES.map((img, i) => (
              <div
                key={img.src}
                className="reveal-scale img-zoom rounded-2xl overflow-hidden break-inside-avoid"
      ...
      <section id="reviews" className="py-24 md:py-32 overflow-hidden">
        <div className="max-w-6xl mx-auto px-6 text-center mb-14 reveal">
          ...
          <div className="flex items-center justify-center gap-3 mb-2">
            <Stars count={5} />
            <span className="text-white/60 font-[family-name:var(--font-inter)] text-sm">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={f.title}
                className="reveal text-center border border-gold/10 rounded-2xl p-8 hover:border-gold/25 transition-all"
              >
                <div className="flex justify-center mb-4">{f.icon}</div>
                <h3 className="font-[family-name:var(--font-playfair)] text-xl font-bold text-white mb-3">
                  {f.title}
                </h3>
                <p className="text-white/50 text-sm font-[family-name:var(--font-inter)] leading-relaxed whitespace-pre-line">
                  {f.desc}
                </p>
              </div>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div className="reveal-left space-y-8">
              <div>
                <h3 className="font-[family-name:var(--font-playfair)] text-2xl font-bold text-white mb-6">
                ...
                <div className="space-y-5">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-white font-[family-name:var(--font-inter)]">
                        Calle Violeta 4, 03320
                      </p>
                      <p className="text-white/50 text-sm font-[family-name:var(--font-inter)]">
                        Torrellano, Alicante, España
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <a
                        href="tel:+34965682817"
                        className="text-white hover:text-gold transition-colors font-[family-name:var(--font-inter)]"
                      >
                        +34 965 68 28 17
                      </a>
                      <p className="text-white/50 text-sm font-[family-name:var(--font-inter)]">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="font-[family-name:var(--font-inter)] text-sm">
                      <div className="flex justify-between gap-8">
                        <span className="text-white/50">Lunes</span>
                        <span className="text-white/30">Cerrado</span>
                      </div>
                      <div className="flex justify-between gap-8">
                        <span className="text-white/50">Mar - Jue</span>
                        <span className="text-white">7:30 - 18:00</span>
                      </div>
                      <div className="flex justify-between gap-8">
                        <span className="text-white/50">Vie - Sáb</span>
                        <span className="text-white">7:30 - 00:00</span>
                      </div>
                      <div className="flex justify-between gap-8">
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="flex items-center gap-2 px-5 py-2.5 border border-gold/20 rounded-full text-white/70 hover:text-gold hover:border-gold/50 transition-all text-sm font-[family-name:var(--font-inter)]"
                >
            ...
            <div className="reveal-right rounded-2xl overflow-hidden border border-gold/10 h-[400px]">
              <iframe
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 reveal">
          <h2 className="font-[family-name:var(--font-playfair)] text-3xl md:text-5xl font-bold text-white mb-4">
            ¿Listo para una{" "}
            <span className="italic font-[family-name:var(--font-lora)] text-gradient-gold">
              experiencia
            </span>{" "}
          ...
          <p className="text-white/60 font-[family-name:var(--font-inter)] mb-8 max-w-lg mx-auto">
            Reserva tu mesa y déjate conquistar por los sabores del Mediterráneo.
          </p>
          <a
            href="tel:+34965682817"
            className="inline-block px-10 py-4 bg-gold text-dark font-bold rounded-full hover:bg-gold-light transition-all text-sm tracking-wider font-[family-name:var(--font-inter)] uppercase"
          >
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-center md:text-left">
              <h3 className="font-[family-name:var(--font-playfair)] text-2xl font-bold text-gradient-gold mb-1">
                El Cortijillo
              </h3>
              <p className="text-white/30 text-sm font-[family-name:var(--font-lora)] italic">
                de Juan Diego
              </p>
            </div>
            <div className="flex items-center gap-6">
              {NAV_LINKS.slice(1).map((l) => (
                <a
                  key={l.href}
                  href={l.href}
                  className="text-white/40 hover:text-gold text-xs transition-colors font-[family-name:var(--font-inter)] uppercase tracking-wide"
                >
                  {l.label}
                </a>
              ))}
